...
function createEditorState() {
  ...
  return {
    ...
    set currentText(v: string) { currentText = v; },
    get activeView() { return activeView; },
    set activeView(v: EditorView | null) { activeView = v; },
    get selectionEpoch() { return selectionEpoch; },
    set selectionEpoch(v: number) { selectionEpoch = v; },
  };
}
