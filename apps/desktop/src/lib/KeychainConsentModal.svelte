...
<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
  ...
  >
    ...
    <p class="text-sm text-base-content/70" style="text-wrap: pretty;">
      To keep you signed in, Muesli saves your login token in the macOS
      Keychain — the same protected store your passwords live in. macOS will
      show a permission prompt next; it grants Muesli access only to its own
      entry, never to your passwords. Muesli stores nothing else there, and
      your token is only ever sent to your own server. Muesli is open source,
