    ...
    <div class="flex items-center gap-2">
      ...
      {#if auth.mode === "oidc" && auth.user}
        <div class="dropdown dropdown-end">
          <div tabindex="0" role="button" class="btn btn-sm btn-primary ml-1">{t("common.share")}</div>
          <div
        ...
        <div class="mb-2 flex items-center justify-between gap-2 border-b border-base-300 pb-2">
          <div class="text-sm">
            ...
            <span class="opacity-60">
              · {t("doc.seq", { seq: collab.snapshot.seq })} · {authorName(collab.snapshot.entry.author)} ·
