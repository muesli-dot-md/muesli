<script lang="ts">
  ...
  // hint "follows your OS". Bound to the same theme store as ThemeModeControl —
  // this is the visual upgrade for the Preferences page; the segmented control
  // still lives in the account dropdown.
