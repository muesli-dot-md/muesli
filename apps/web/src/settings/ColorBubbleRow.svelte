<script lang="ts">
  ...
  // (background.svelte.ts / folderColor.svelte.ts). Web port of
  // apps/desktop/src/lib/settings/ColorBubbleRow.svelte — kept byte-identical
  // apart from the import specifiers (this app has no $lib alias and ships
  // @lucide/svelte); mirror any change.
