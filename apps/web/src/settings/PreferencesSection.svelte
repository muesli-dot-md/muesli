...
<SettingsCard>
  ...
  <SettingRow title={t("settings.defaultView")} description={t("settings.defaultView.hint")}>
    {#snippet control()}
      <div class="join">
        <button
          class="btn join-item btn-sm gap-1 {prefs.homeView === 'list' ? 'btn-active' : 'btn-ghost'}"
        ...
        <button
          class="btn join-item btn-sm gap-1 {prefs.homeView === 'grid' ? 'btn-active' : 'btn-ghost'}"
        ...
        <button
          class="btn join-item btn-sm gap-1 {prefs.homeView === 'tree' ? 'btn-active' : 'btn-ghost'}"
