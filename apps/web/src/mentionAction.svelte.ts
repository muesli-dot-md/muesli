...
// apps/desktop/src/lib/collab/mentionAction.svelte.ts (identical; no i18n strings here).
//
...
import { detectTrigger, filterMembers, insertMention, chipDeletion, type Member } from "./mentions";
