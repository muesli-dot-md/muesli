                ...
                <tr>
                  ...
                  <td>
                    <div class="flex items-center gap-1.5">
                      ...
                      {/if}
                      {#if m.kind === "agent"}
                        <span class="badge badge-secondary badge-xs gap-0.5" title={t("ws.delegatedAgentIdentity")}>
                          {t("ws.agentBadge")}
                        </span>
                      {/if}
                    </div>
              ...
              <table class="table table-xs mb-1">
                ...
                <tbody>
                  {#each auditEntries as e (e.id)}
                    <tr>
                      <td>
                        <span class="badge badge-ghost badge-xs font-mono">{actionLabel(e.action)}</span>
                      </td>
                      <td>
