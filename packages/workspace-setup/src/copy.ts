...
export const EN = {
  ...
  "wizard.s3CardBody": "AWS S3, MinIO, or Cloudflare R2. You create an access key scoped to one bucket.",
  "wizard.gdriveCard": "Google Drive",
  "wizard.gdriveCardBody": "A Muesli folder in your Drive. You approve access in your Google account.",
  ...
  "wizard.driveHint45": "Still waiting. If no window opened, check your popup blocker or sign in to the web app first.",
  "wizard.driveHint90": "This is taking a while. You can go back and pick a different storage option.",
  "wizard.doneTitle": "Your workspace is ready",
  "wizard.doneBody": "Files sync to your storage as you type. Invite people from workspace settings.",
  ...
  "wizard.spPlaceholderHint": "{tenant} and {site_url} fill in once you enter them in the next step.",
...
export function makeT(override?: (key: string, params?: Record<string, string | number>) => string) {
