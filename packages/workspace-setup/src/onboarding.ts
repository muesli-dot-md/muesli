...
export type OnboardingContext =
  { kind: "create" } | { kind: "invited"; workspaceName: string } | { kind: "desktop" };
...
export function screenCopyKeys(screen: OnboardingScreen, context: OnboardingContext): WizardKey[] {
  switch (screen) {
    case "welcome":
      return [
    ...
    case "action":
      switch (context.kind) {
        case "create":
          return [
            "onboarding.createTitle",
            "onboarding.createBody",
            "onboarding.createButton",
            "onboarding.skip",
            "wizard.back",
            "wizard.stepOf",
          ];
        case "invited":
          return [
            "onboarding.invitedTitle",
            "onboarding.invitedBody",
            "onboarding.invitedButton",
            "onboarding.skip",
            "wizard.back",
            "wizard.stepOf",
          ];
