...
export function librariesBody(
  s: SpState,
): { tenant: string; site_url: string } & SharePointCredentials {
...
export function connectBody(s: SpState): Extract<CreateStorageBody, { kind: "sharepoint" }> | null {
