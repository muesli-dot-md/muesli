...
auto-links within seconds; a deleted file stops its session but the server doc and index
entry are kept (never destructive); a rename with identical content re-binds to the same
