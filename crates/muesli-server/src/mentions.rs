...
mod tests {
    ...
    fn extracts_single_mention_id() {
        let body = "hey @[Ada Lovelace](muesli:user/00000000-0000-0000-0000-000000000001) take a look";
        assert_eq!(
            parse_mentions(body),
    ...
    fn valid_mention_after_a_malformed_one_is_still_found() {
        let body = "@[bad](muesli:user/nope) then @[ok](muesli:user/00000000-0000-0000-0000-0000000000ff)";
        assert_eq!(
            parse_mentions(body),
